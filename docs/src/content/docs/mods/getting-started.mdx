...
:::tip
You can also use the [`knockoutcity-mod-create`](https://www.npmjs.com/package/knockoutcity-mod-create) Package to create a template.
Than you can skip all the manual setup and jump right into the action!
...
We can now package it by zipping the `dist` folder together with the `manifest.yml` file. This will allow us to easily share our mod.
